...
public class AppTest {
    ...
    public void testConstructorFilters() {
        final String[] args = {"list", "/Users/renevanputten/Dropbox/Books/Manning Books/50 Android Hacks", "-s", "-r"};
    ...
    public void testList() {
        final String[] args = {"list", "/Users/renevanputten/Dropbox/Books/Manning Books/50 Android Hacks", "-m", "-r"};
        final AppCommandLine commandLine = AppCommandLine.getInstance(args);
        final App app = new App(commandLine);
